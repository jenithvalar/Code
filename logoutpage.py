        ...
        if user_input.lower() == 'yes':
            ...
            if logout_success:
                self.write_report_to_file(report_logout,
                                          r"C:\Users\jenith.ravichandran\PycharmProjects\AspireDashboard\reports\logout.txt")
            ...
            if user_input2.lower() == 'yes':
                ...
                if re_login_success:
                    self.write_report_to_file(re_login,
                                              r"C:\Users\jenith.ravichandran\PycharmProjects\AspireDashboard\reports\relogin.txt")
                    ...
                    if dashboard_text == 'Dashboard':
                        ...
                        self.write_report_to_file(dashboard_nav,
                                                  r"C:\Users\jenith.ravichandran\PycharmProjects\AspireDashboard\reports\dashboard_nav.txt")
                    else:
                        dashboard_error = "The text is not matched. You missed navigating to the dashboard"
                        self.write_report_to_file(dashboard_error,
                                                  r"C:\Users\jenith.ravichandran\PycharmProjects\AspireDashboard\reports\dashboard_error.txt")
